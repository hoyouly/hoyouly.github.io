...
![performTraversals()流程图](https://github.com/hoyouly/BlogResource/raw/master/imgesperformTraversals.png)
...
```
代码换成表格形式就是如下。
![](https://github.com/hoyouly/BlogResource/raw/master/imgesview_measurespce_parent_measurespce.png)
