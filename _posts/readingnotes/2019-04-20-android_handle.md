...
如下图
![添加图片](../../../../../article-detail/images/creat_handler.png)
这两种的区别后面会说道   
...
如下图所示   
![添加图片](../../../../../article-detail/images/handler_leank.png)
...
流程图如下
![添加图片](../../../../../article-detail/images/handlemessage_post.png)
...
```
![添加图片](../../../../../article-detail/images/handler_post.png)
...
```
转换成流程图如下
![添加图片](../../../../../article-detail/images/enqueuemessage.png)
主要做了两件事
1. 插入到消息队列中
...
![添加图片](../../../../../article-detail/images/looper_prepare.png)
...
```
再来一份流程图
![添加图片](../../../../../article-detail/images/looper_loop.png)
这里面主要看两个地方
1. 取消息  queue.next()
...
```
这个代码很短，可以直接看流程图
![添加图片](../../../../../article-detail/images/handler_dispatchmessage.png)
...
如下图所示。  
![添加图片](../../../../../article-detail/images/handler_thread.png)
