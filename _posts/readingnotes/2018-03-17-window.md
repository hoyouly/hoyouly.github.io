...
在之前文章  [View 的绘制 - Draw 流程，invalidate 的流程 以及 requestLayout 流程](../../../../../article-detail/2018/06/29/view_draw_procress_draw/#viewrootimpl--requestlayout)  中讲过。
...
整个流程图如下
![添加图片](../../../../../article-detail/images/Window_addView.png)
...
整个流程图如下
![添加图片](../../../../../article-detail/images/Window_remove.png)
