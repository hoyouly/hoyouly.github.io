...
在之前文章  [View 的绘制 --- Draw 流程，invalidate的流程 以及 requestLayout 流程](http://hoyouly.fun/2018/06/29/view_draw_procress_draw/#viewrootimpl--requestlayout)  中讲过。
...
整个流程图如下
![添加图片](https://github.com/hoyouly/BlogResource/raw/master/imges/Window_addView.png)
...
整个流程图如下
![添加图片](https://github.com/hoyouly/BlogResource/raw/master/imges/Window_remove.png)
