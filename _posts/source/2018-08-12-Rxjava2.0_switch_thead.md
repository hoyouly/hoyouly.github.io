...
```
1. 创建 NewThreadWorker 时候就会创建一个 executor，而executor 就是一个线程池。并且是ScheduledExecutorService 类型的。关于线程池的相关知识，可以查看 [Android 线程池](../../../../../article-detail/2018/05/12/Android-ThreadPoolExecutor/)
```java
