...
4. 启用插件
    ...
    ![access key](https://github.com/hoyouly/BlogResource/blob/master/imges/qiniu-access-key.png)

    ![root url](https://github.com/hoyouly/BlogResource/blob/master/imges/qiniu-root-url.png)
