...
3. new String("abc"　)  ： 肯定是创建 String 对象，因为new 在这里嘛，可是真的是一个吗？
...
查看源码我们发现，new String("abc"),接受的对象竟然还是String对象，那么就说明“abc”也是一个String对象，这个"abc"对象怎么来的呢，答案就是在JVM常量池，那么JVM字符串常量池是啥玩意呢
...
解释：
1. JVM 首先在字符串常量池中查找是否已经存在一个值为“abc”的对象，它的判断依据就是String类中的equals()方法的返回值，如果有，则不在创建新的对象，直接把该对象的引用返回，如果没有，则创建一个这个对象，然后把他添加到常量池里面。再返回这个对象的引用并赋值给str
...
## JVM 结构图
先看看下面这张虚拟机的结构图  
![虚拟机的结构图](../../../../../article-detail/images/jvm.jpg)
...
## Stacks 区
![](../../../../../article-detail/images/51f4a70e8f951c8c3d9c0eee21e2157c_r.jpg)
...
![](../../../../../article-detail/images/100add80.jpg)
...
![](../../../../../article-detail/images/efe43f0a055aa7f36931ab417fb05811_hd.jpg)
...
![](../../../../../article-detail/images/hello_object.jpg)
...
![](../../../../../article-detail/images/20568a6ad0ef2860746533595e400716_r.jpg)
...
```
![](../../../../../article-detail/images/8e743518809bd37723a4b0e8bf35f332_r.jpg)
...
![](../../../../../article-detail/images/fe6b27f35b5491eb562138eda573c238_r.jpg)
